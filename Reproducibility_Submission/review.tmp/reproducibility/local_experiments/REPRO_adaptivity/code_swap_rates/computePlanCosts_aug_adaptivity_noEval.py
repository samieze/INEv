...
def main():
   ...
   # print("Hop Latency: " + str(hoplatency))
    ...
    myResult = [experiment, swaps, skew, costs, ccosts[0]]
    new = False
    
    try:
        f = open("../adaptivity_swap_rates/results_inev_"+str(skew)+".csv")   
    except FileNotFoundError:
        new = True           

    with open("../adaptivity_swap_rates/results_inev_"+str(skew)+".csv",'a')  as result:
